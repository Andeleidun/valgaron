...
import {
  ...
  getAcademicProfileEducationFormConfig,
  getAcademicProfileHighlightsFormConfig,
  getAcademicProfileJobHistoryFormConfig,
...
type AcademicProfileFormProps = {
  strings: ProfileStringsType['academic'] &
...
const AcademicProfileForm = ({
  ...
  const useProfile = userContext.user.academic ?? blankAcademicProfile;
  const profileFormStore = useFormStore(
    () => getAcademicBaseFormState({ useProfile }),
    {
  ...
  const jobHistoryFormStore = useFormStore(() => ({ ...blankJobHistoryData }));
  ...
  const persistProfile = async () => {
    ...
    const errors = validateProfileFormData('academic', currentProfileFormData);
    ...
    setSaveErrorMessage('');
    const submission: AcademicProfileDataType = getAcademicProfileSubmission({
      useProfile,
  ...
  const academicProfileMainFormConfig = getAcademicProfileMainFormConfig({
    strings,
    profileFormData,
    language,
  });

  const academicProfileAboutFormConfig = getAcademicProfileAboutFormConfig({
    profileFormData,
    strings,
    language,
  });

  const academicConnectionStyleFormConfig =
    getAcademicConnectionStyleFormConfig({
      profileFormData,
      strings,
      language,
  ...
  const academicProfileHighlightsFormConfig =
    getAcademicProfileHighlightsFormConfig({
      profileFormData,
      language,
      strings,
  ...
  const academicProfileConferencesFormConfig =
    getAcademicProfileConferencesFormConfig({
      profileFormData,
      strings,
      language,
  ...
  const EducationSection = () => {
    ...
    const educationConfig = getAcademicProfileEducationFormConfig({
      profileFormData: {
  ...
  const JobHistorySection = () => {
    ...
    const jobHistoryConfig = getAcademicProfileJobHistoryFormConfig({
      profileFormData: {
        ...currentProfileValues,
  ...
  const formStructure = [
    {
      key: 'main',
      content: renderProfileFormConfig(academicProfileMainFormConfig),
    },
    {
      key: 'connection-style',
      title: strings.connectionStyleCommon.sectionTitle[language],
      content: renderProfileFormConfig(academicConnectionStyleFormConfig),
    },
    {
      key: 'about',
      title: strings.questions.about.title[language],
      content: renderProfileFormConfig(academicProfileAboutFormConfig),
    },
    {
      key: 'highlights',
      title: strings.questions.highlights.title[language],
      content: renderProfileFormConfig(academicProfileHighlightsFormConfig),
    },
    {
      key: 'education',
    ...
    {
      key: 'conferences',
      title: strings.questions.conferences.title[language],
      content: renderProfileFormConfig(academicProfileConferencesFormConfig),
    },
  ];
  ...
  return (
    <ProfileFormScaffold
      ...
      picturesFieldId="academic-profile-pictures-input"
