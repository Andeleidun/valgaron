    ...
    characters: [
      entry({
        ...
        fields: {
          role: 'Treaty scribe',
          home: 'Moonspire Port',
          affiliation: 'The Inkbound Cartel',
          statusNote: 'Preparing the Moonspire accord',
        },
      }),
      entry({
        ...
        fields: {
          ...
          statusNote: 'Hiding old route maps',
        },
      }),
    ],
    places: [
    ...
    characters: [
      entry({
        ...
        fields: {
          role: 'River pilot',
          home: 'Reedwake',
          affiliation: 'Tidecallers',
          statusNote: 'Collecting oral histories',
        },
      }),
    ],
    places: [
