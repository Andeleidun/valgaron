...
| Character logical tree fields     | Resolved with shared character taxonomy | Core character taxonomy | Grouped field controls     | Grouped field controls                   | Closed   | Same category fields, suggestions, and links |
...
| Character logical tree     | Category-driven field groups, flexible ancestry/profession suggestions, linked relationship controls           | Category-driven field groups, flexible ancestry/profession suggestions, linked relationship controls           | Keep covered by shared character taxonomy and mobile editor model     |
